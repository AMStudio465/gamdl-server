const APPLE_MUSIC_HOMEPAGE_URL = "https://music.apple.com";
const APPLE_MUSIC_COOKIE_DOMAIN = ".music.apple.com";
...
const ITUNES_PAGE_API_URL = "https://music.apple.com";

const SONG_MEDIA_TYPE = new Set(["song", "songs", "library-songs"]);
const ALBUM_MEDIA_TYPE = new Set(["album", "albums", "library-albums"]);
const MUSIC_VIDEO_MEDIA_TYPE = new Set(["music-video", "music-videos", "library-music-videos"]);
const ARTIST_MEDIA_TYPE = new Set(["artist", "artists", "library-artists"]);
const UPLOADED_VIDEO_MEDIA_TYPE = new Set(["post", "uploaded-videos"]);
const PLAYLIST_MEDIA_TYPE = new Set(["playlist", "playlists", "library-playlists"]);
